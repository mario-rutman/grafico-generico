...
Para criar cores complementares esta função é fundamental: wheel("nome da cor", num = quantidade de cores complementares que desejamos). É do pacote colortools.
